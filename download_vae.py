...
os.system('huggingface-cli download --resume-download stabilityai/sd-vae-ft-ema --local-dir /home/duanjunwen/LCProj/Open-Sora/pretrained_models/stabilityai/sd-vae-ft-ema --local-dir-use-symlinks False')
