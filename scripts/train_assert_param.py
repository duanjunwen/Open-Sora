...
def main():
    ...
    torch.save(vae.state_dict(), f"./dataset/assert_closed/torch_tensor/vae_param_init.txt")
    ...
    torch.save(model.state_dict(), f"./dataset/assert_closed/torch_tensor/stdit_param_init.txt")
    
    # Assert 4: save optim state
    torch.save(optimizer.state_dict(), f"./dataset/assert_closed/torch_tensor/optim_state_init.txt")
    ...
    for epoch in range(start_epoch, cfg.epochs):
        ...
        with tqdm(
            ...
            for step, batch in pbar:
                ...
                torch.save(x, f"./dataset/assert_closed/torch_tensor/step{epoch * num_steps_per_epoch + step}_vae_input.txt")
                
                # Assert 6: assert t5 input
                torch.save(y, f"./dataset/assert_closed/torch_tensor/step{epoch * num_steps_per_epoch + step}_t5_input.txt")
                ...
                torch.save(model_args, f"./dataset/assert_closed/torch_tensor/step{epoch * num_steps_per_epoch + step}_t5_output.txt")
                ...
                torch.save(model.state_dict(), f"./dataset/assert_closed/torch_tensor/step{epoch * num_steps_per_epoch + step}_stdit_param_step.txt")
                # Assert 12: assert optim state    
                torch.save(optimizer.state_dict(), f"./dataset/assert_closed/torch_tensor/step{epoch * num_steps_per_epoch + step}_optim_state_step.txt")
